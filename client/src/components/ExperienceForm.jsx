    ...
    <div className='space-y-6'>
      ...
      {data.length === 0?(
        <div className='text-center py-8 text-gray-500'>
            ...
            <p className='text-sm'>Click add experience</p>
        </div>
      ):(
            ...
            {data.map((experience, index)=>(
                <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                    ...
                    <div className='space-y-2'>
                        ...
                        <textarea value={experience.description || ""} onChange={(e)=>updateExperience(index, "description", e.target.value)} rows={4} className='w-full text-sm px-3 py-2 rounded-lg resize-none' placeholder='describe your responsibilites in the job' />
                    </div>
